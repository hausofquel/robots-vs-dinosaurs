...
# As a developer, I want to make a class fro each of the following: Robot, Dinosaur, Weapon, Battlefield.
...
# As a developer, I want a Weaopn to hahve a name and attack_power.
...
# As a developer, I want a Robot to have the ability to attack a Dinosaur on a Battlefield. This attack method should lowere the Dinosaur's health by the attack_power of the Robot's active_weapon.

# As a developer, I want the battle to conclude once either the robot or the dinosaur has its health points reduced to zero.

# As a devloper, I want to choose from a List of 3 possible weapons before the robot makes an attack.
